<%@ Page Title="" Language="C#" MasterPageFile="~/Metronic.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="TrainingASP.PencapaianProgram.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">Kemaskini Pencapaian Program
                </h3>
            </div>
        </div>
    </div>
 ...
 <asp:Button ID="btnBack" runat="server" Text="Tutup" class="btn btn-primary" OnClick="btnBack_Click" />
